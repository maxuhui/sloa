...
public class TwoDimensionCode {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String imgPath = "C:\\Users\\maxuh\\Desktop\\zhaochao.png";
        String encoderContent = "";
        for (int i = 0; i < 40; i++)
            encoderContent += "赵";

        encoderQRCode(encoderContent, imgPath, "png", 10);
        ...
        InputStream inStream = encoderQRCode(encoderContent);
        InputStream inputStream = new BufferedInputStream(inStream);
